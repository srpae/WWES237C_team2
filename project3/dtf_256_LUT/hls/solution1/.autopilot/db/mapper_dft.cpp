...
extern "C" void apatb_dft_hw(volatile void * __xlx_apatb_param_real_sample, volatile void * __xlx_apatb_param_imag_sample) {
  ...
  int __xlx_size_param_real_sample = 256;
  ...
  int __xlx_size_param_imag_sample = 256;
  ...
  // DUT call
  dft(__xlx_real_sample__input_buffer, __xlx_imag_sample__input_buffer);
